...
def training_u_net_lstm():
    ...
    for distro in distros_dict: 
        ...
        fig_loss.savefig('Plots/U-Net_LSTM/Learning_curve_original.png')
        fig_acc.savefig('Plots/U-Net_LSTM/Jaccard_Loss_Curve_original.png')

        ################saving the model to the folder Models##########################
        # Save the weights
        model.save_weights('Saved_Models/U_Net_LSTM/U_Net_LSTM_weights_original.h5')
