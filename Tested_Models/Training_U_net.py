...
def training_u_net():
    ...
    for distro in distros_dict: 
        ...
        # Save the weights
        model.save_weights('Saved_Models/U_Net/U_Net_weights_BN_{}_DA_{}_BW_{}.h5'.format(distro['batch_normalization'],distro['data_augmentation'],distro['balanced_weights']))
